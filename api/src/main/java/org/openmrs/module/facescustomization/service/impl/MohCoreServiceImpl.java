...
import org.openmrs.module.facescustomization.db.MohCoreDAO;
import org.openmrs.module.facescustomization.service.MohCoreService;
...
public class MohCoreServiceImpl extends BaseOpenmrsService implements MohCoreService {
	...
	public PatientIdentifierType getCCCNumberIdentifierType() {
		String typeId = Context.getAdministrationService().getGlobalProperty(FacesCustomReportsConstants.GP_CCC_NUMBER_IDENTIFIER_TYPE);
    ...
    public PersonAttributeType getTBRegAttributeType() {
        String typeId = Context.getAdministrationService().getGlobalProperty(FacesCustomReportsConstants.TB_REGISTRATION_NO_ATTRIBUTE_TYPE);
