package org.openmrs.module.facescustomization.util;
...
import org.openmrs.module.facescustomization.rule.MohEvaluableNameConstants;
...
import org.openmrs.module.facescustomization.cache.MohCacheUtils;
...
public class MOHReportUtil {
	...
	public static String joinAsSingleCell(Collection<String> entries) {
		return StringUtils.join(entries, FacesCustomReportsConstants.INTER_CELL_SEPARATOR);
	}
	...
	public static void renderCSVFromReportData(ReportData results, OutputStream out) throws IOException {
		...
		CSVWriter w = new CSVWriter(new OutputStreamWriter(out,"UTF-8"), FacesCustomReportsConstants.DEFAULT_CSV_DELIMITER);
	...
	public static Map<String, Object> renderDataSetFromCSV(InputStream in) throws IOException {
		CSVReader r = new CSVReader(new InputStreamReader(in, "UTF-8"), FacesCustomReportsConstants.DEFAULT_CSV_DELIMITER);
