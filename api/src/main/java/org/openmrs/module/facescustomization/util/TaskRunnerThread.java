...
import org.openmrs.module.facescustomization.task.FacesCustomReportsTask;
...
public class TaskRunnerThread extends Thread {
	 ...
	 */
	private FacesCustomReportsTask task = null;
	 ...
	 */
	public void initialize(FacesCustomReportsTask task, UserContext userContext) {
		this.task = task;
	...
	public FacesCustomReportsTask getTask() {
		return task;
	}

	public void setTask(FacesCustomReportsTask task) {
		this.task = task;
	}
