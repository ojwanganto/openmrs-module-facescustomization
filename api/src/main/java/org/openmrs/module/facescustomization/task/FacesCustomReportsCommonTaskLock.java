 ...
 */
public class FacesCustomReportsCommonTaskLock {

	static private FacesCustomReportsCommonTaskLock instance = null;
	 ...
	 */
	public FacesCustomReportsCommonTaskLock() {
		locked = false;
	 ...
	 */
	public static FacesCustomReportsCommonTaskLock getInstance() {
		if (instance == null)
			instance = new FacesCustomReportsCommonTaskLock();
		return instance;
	}
